"""Serving SLO Circuit — SCAFFOLD STUB.

Company lens: Baseten (independent; no affiliation).
Bottleneck: Model serving endpoints over-admit traffic when tail latency and error budgets drift without a hard circuit.
...
class ServingSloCircuit:
    ...
    - `evaluate(req)` returns a ServingSloCircuitReceipt
    ...
    def evaluate(self, req: ServingSloCircuitRequest) -> ServingSloCircuitReceipt:
        ...
        if reasons:
            ...
            return ServingSloCircuitReceipt(
